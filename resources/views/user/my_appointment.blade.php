...
<body>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupport">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" style="background-color: #01F9C6; color: white" href="{{url('myappointment')}}">My Appointment</a>
            </li>
  ...
  <div align="center" style="padding:70px;">
    <table>
        <tr style="background-color:#01F9C6;">
        ...
        <tr style="background-color:#033E3E;" align="center">
            ...
            <td>
                <a href="{{ url('cancel_appoint', $appoints->id) }}"
